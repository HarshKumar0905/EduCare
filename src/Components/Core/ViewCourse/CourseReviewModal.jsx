                ...
                <div className="p-6">
                    ...
                    className="mt-6 flex flex-col items-center">
                        ...
                        <div className='w-full flex flex-col space-y-2'>
                            <label htmlFor='courseExperience' className='mx-auto text-sm text-richblack-5'>
                                Add Your Experience <sup className=' text-pink-200'>*</sup>
                            </label>
                            <textarea id='courseExperience' placeholder='Enter Your Course Experience'
                              {...register("courseExperience",{required:true})}
                              style={{
                              boxShadow: "inset 0px -2px 0px rgba(255, 255, 255, 0.18)",
                              }}
                              className="rounded-[0.5rem] min-h-[130px] bg-richblack-700 p-[12px] text-richblack-5"
                            />
                            {
                        ...
                        <div className="mt-6 flex w-11/12 justify-end gap-x-2">
                            ...
                            py-[8px] px-[20px] font-semibold text-richblack-900 transition-all duration-200
                            hover:scale-95`}>
                                Cancel
                            </button>
                            <IconBtn text="Save">
