...
const CourseInformationForm = () => {
    ...
    return(
        ...
        className="space-y-8 rounded-md border-[1px] mt-16 
        border-richblack-700 bg-richblack-800 p-6">
            ...
            <div className='flex flex-col space-y-2'>
                ...
                <textarea id='courseShortDesc' placeholder='Enter Description'
                  ...
                  className="w-full rounded-[0.5rem] min-h-[130px] bg-richblack-700 p-[12px] text-richblack-5"
                />
                {
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="relative">
                    <input
                      ...
                      className="w-full rounded-[0.5rem] bg-richblack-700 p-[12px] text-richblack-5 pl-11"
                    />
            ...
            <div className="flex justify-end gap-2">
            {
                ...
                <IconBtn disabled={loading} text={editCourse ? "Save Changes" : "Next"} type="Submit">
                    <MdNavigateNext />
                </IconBtn>
            </div>
        </form>
